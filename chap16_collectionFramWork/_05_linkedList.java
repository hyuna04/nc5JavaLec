...
public class _05_linkedList {
	// TODO Auto-generated method stub
			...
			//remove(in index) 인덱스로 데이터 삭제하는 속도 비교
			startTime = System.nanoTime();
			
			for(int i4 = 1000; i < 5000; i++) {
				aList.remove(i);
			}
